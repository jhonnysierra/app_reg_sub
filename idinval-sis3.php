...
<html>
   ...
   <body>
	<form name=consulta method=post action=idinval-sis3.php>
...
<?php
	...
	echo"<table width=100%  border=0 class='encab'>";
		...
		echo"<tr>";
		echo"<td>Lista de identidades invalidas que no están en sisben por documento (".$cont.")</td>";		    
		echo"</tr>";
	...
	echo"<tr>";
	echo"<td><a href=exidinval-sis.php>Exportar datos a Excel</a></td>";
	echo"</tr>";
	echo"</table>"; 
