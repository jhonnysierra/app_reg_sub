...
<html>
   ...
   <body>
	<form name=consulta method=post action=may18contri.php>
...
<?php
	...
	echo"<table width=100%  border=0 class='encab'>";
		...
		echo"<tr>";
		echo"<td>Lista de registros de régimen contributivo que necesitan actualizar documento a cedula (".$cont.")</td>";		    
		echo"</tr>";
	...
	echo"<td>TIPO ID</td><td>NUMERO ID</td><td>APELLIDO1</td><td>APELLIDO2</td><td>NOMBRE1</td><td>NOMBRE2</td><td>FE. NACIMIENTO</td><td>EDAD</td><td>DEPARTAMENTO</td><td>MUNICIPIO</td><td>ESTADO</td><td>EPS</td>";
	...
	echo"<tr>";
	echo"<td><a href=exmay18contri.php>Exportar datos a Excel</a></td>";
	echo"</tr>";
	echo"</table>";
