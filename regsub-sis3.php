...
<html>
   ...
   <body>
	...
	<form name=consulta method=post action=regsub-sis3.php>
...
<?php
	...
	$cont=0;
		...
		while($j<$fil)
			...
			$consul="select nuficha from sisben where nuficha='$fich[$j]'";
...
<?php
	...
	echo"<table width=100%  border=0 class='encab'>";
		...
		echo"<tr>";
		echo"<td>Lista de registros de régimen subsidiado que no están en sisben por ficha (".$cont.")</td>";		    
		echo"</tr>";
	...
	echo"<br></br>";
  	...
  	echo"<table width=80% align=left border=0>";
	echo"<tr>";
	echo"<td><a href=exregsub-sis3.php>Exportar datos a Excel</a></td>";
	echo"</tr>";
	echo"</table>";  
