...
<html>
   ...
   <body>
	...
	<form name=consulta method=post action=actregsubval.php>
...
<?php		
	...
	$today = date("Y-m-d");
		...
		$consulta="select ideafi,apellido1,apellido2,nombre1,nombre2 from regsubvalido";
...
<?php
	   ...
	   while($j<$fil)
		{	 
			...
			$consult="update regsubvalido set ideafi='$cedu[$j]',apellido1='$apell1[$j]',apellido2='$apell2[$j]',nombre1='$nomb1[$j]',nombre2='$nomb2[$j]' where ideafi='$ced[$j]' and apellido1='$ape1[$j]' and apellido2='$ape2[$j]' and nombre1='$nom1[$j]' and nombre2='$nom2[$j]'";
...
<?php		
		...
		$consulta2="select ideafi,apellido1,apellido2,nombre1,nombre2 from regsubvalido";
...
<?php
	   ...
	   while($b<$fil2)
		{	 
			...
			$consult2="update regsubvalido set apellido1='$apelli1[$b]',apellido2='$apelli2[$b]',nombre1='$nombre1[$b]',nombre2='$nombre2[$b]' where ideafi='$cedula[$b]' and apellido1='$apel1[$b]' and apellido2='$apel2[$b]' and nombre1='$nombr1[$b]' and nombre2='$nombr2[$b]'";
