...
<html>
   ...
   <body>
	<form name=consulta method=post action=sis-rg-con.php>
...
<?php
		...
		while($j<$filas)
 			...
 			$consulta="select tipoideafi,ideafi,apellido1afi,apellido2afi,nombre1afi,nombre2afi from regsub where ideafi='$ced[$j]' and (np='1' or np='2')";
...
<?php
	...
	while($a<$cont)
		...
		$consult="select tipo_ide,numide,apellido1,apellido2,nombre1,nombre2 from contributivo where numide='$cedu[$a]'";
	...
	echo"<table width=100%  border=0 class='encab'>";
		...
		echo"<tr>";
		echo"<td>Lista de priorizados por documento (".$cont2.")</td>";		    
		echo"</tr>";
	...
	echo"<tr>";
	echo"<td><a href=exsis-rs-con.php>Exportar datos a Excel</a></td>";
	echo"</tr>";
	echo"</table>";
