...
<html>
   ...
   <body>
	<form name=consulta method=post action=idinval-sis2.php>
...
<?php
	...
	echo"<table width=100%  border=0 class='encab'>";
		...
		echo"<tr>";
		echo"<td>Lista de identidades invalidas que están en sisben por nombres (".$cont.")</td>";		    
		echo"</tr>";
	...
	echo"<tr>";
	echo"<td><a href=exidinval-sis2.php>Exportar datos a Excel</a></td>";
	echo"</tr>";
	echo"</table>"; 
