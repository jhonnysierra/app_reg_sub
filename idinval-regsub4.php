...
<html>
   ...
   <body>
	<form name=consulta method=post action=idinval-regsub4.php>
...
<?php
	...
	$cont=0;
		...
		while($j<$filas)
			...
			$consul="select ideafi from regsub where apellido1afi='$ape1[$j]' and apellido2afi='$ape2[$j]' and nombre1afi='$nom1[$j]' and nombre2afi='$nom2[$j]'";
...
<?php
	...
	echo"<table width=100%  border=0 class='encab'>";
		...
		echo"<tr>";
		echo"<td>Lista de identidades invalidas que no están en régimen subsidiado por nombres (".$cont.")</td>";		    
		echo"</tr>";
	...
	echo"<tr>";
	echo"<td><a href=exidinval-regsub4.php>Exportar datos a Excel</a></td>";
	echo"</tr>";
	echo"</table>"; 
