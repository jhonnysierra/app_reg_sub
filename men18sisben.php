...
<html>
   ...
   <body>
	<form name=consulta method=post action=men18sisben.php>
...
<?php
	...
	echo"<table width=100%  border=0 class='encab'>";
		...
		echo"<tr>";
		echo"<td>Lista de registros de sisben que necesitan actualizar documento a tarjeta de identidad (".$cont.")</td>";		    
		echo"</tr>";
	...
	echo"<tr>";
	echo"<td><a href=exmen18sisben.php>Exportar datos a Excel</a></td>";
	echo"</tr>";
	echo"</table>";
