...
<html>
   ...
   <body>
	<form name=consulta method=post action=homocontri2.php>
...
<?php
	...
	$cont=0;
		...
		while($j<$fil)
			...
			$consul="select numide from contributivo where apellido1='$ape1[$j]' and apellido2='$ape2[$j]' and nombre1='$nom1[$j]' and nombre2='$nom2[$j]'";
...
<?php
	...
	echo"<table width=100%  border=0 class='encab'>";
		...
		echo"<tr>";
		echo"<td>Lista de homónimos de régimen contributivo por nombres (".$cont.")</td>";		    
		echo"</tr>";
	...
	echo"<table width=100% align=center class='inf'>";
	...
	echo"<tr>";
	echo"<td><a href=exphocontri2.php>Exportar datos a Excel</a></td>";
	echo"</tr>";
	echo"</table>";  
