...
<html>
   ...
   <body>
	<form name=consulta method=post action=regsubcontri2.php>
...
<?php
	...
	$cont=0;
		...
		while($j<$fil)
			...
			$consul="select numide,estado from contributivo where apellido1='$ape1[$j]' and apellido2='$ape2[$j]' and nombre1='$nom1[$j]' and nombre2='$nom2[$j]'";
...
<?php
	...
	echo"<table width=100%  border=0 class='encab'>";
		...
		echo"<tr>";
		echo"<td>Lista de registros que están en régimen subsidiado y están en régimen contributivo por nombres (".$cont.")</td>";		    
		echo"</tr>";
	...
	echo"<td>CONSECUTIVO</td><td>EPS</td><td>TIPO DOC</td><td>ID. CABEFA</td><td>TIPO DOC</td><td>ID. AFILIADO</td><td>APELLIDO 1</td><td>APELLIDO 2</td><td>NOMBRE 1</td><td>NOMBRE 2</td><td>FE. NACIMIENTO</td><td>SEXO</td><td>TIPOAFI</td><td>PARENTESCO</td><td>GRUPO</td><td>NIVEL SISBEN</td><td>FICHA</td><td>CONBEN</td><td>DEPART</td><td>MUNICI</td><td>AREA</td><td>AFISITEMA</td><td>AFIARS</td><td>NUMCONTRA</td><td>FECONTRA</td><td>TIPOCONTRA</td><td>GRUPO</td><td>MODSUB</td><td>DIRECCION</td><td>ACUERDO</td><td>FECHANOVE</td><td>ESTADO</td><td>ESTADO CONTRI</td><td>OBSERVACION</td></tr>";
	...
	echo"<tr>";
	echo"<td><a href=exregsubcontri2.php>Exportar datos a Excel</a></td>";
	echo"</tr>";
	echo"</table>";  
