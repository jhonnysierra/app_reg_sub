...
<html>
   ...
   <body>
	<form name=consulta method=post action=idinval-regsub.php>
...
<?php
	...
	echo"<table width=100%  border=0 class='encab'>";
		...
		echo"<tr>";
		echo"<td>Lista de identidades invalidas que están en régimen subsidiado por documento (".$cont.")</td>";		    
		echo"</tr>";
	...
	echo"<tr>";
	echo"<td><a href=exidinval-regsub.php>Exportar datos a Excel</a></td>";
	echo"</tr>";
	echo"</table>"; 
