...
<html>
   ...
   <body>
	<form name=consulta method=post action=homodgas2.php>
...
<?php
	...
	echo"<table width=100%  border=0 class='encab'>";
		...
		echo"<tr>";
		echo"<td>Lista de homónimos de DGAS por nombres (".$cont.")</td>";		    
		echo"</tr>";
	...
	echo"<tr>";
	echo"<td><a href=exphodgas2.php>Exportar datos a Excel</a></td>";
	echo"</tr>";
	echo"</table>";
?>
