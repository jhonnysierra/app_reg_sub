...
<html>
   ...
   <body>
	<form name=consulta method=post action=may18regsubval.php>
...
<?php
	...
	echo"<table width=100%  border=0 class='encab'>";
		...
		echo"<tr>";
		echo"<td>Lista de registros de régimen subsidiado validado que necesitan actualizar documento a cedula (".$cont.")</td>";		    
		echo"</tr>";
	...
	echo"<tr>";
	echo"<td><a href=exmay18regsubval.php>Exportar datos a Excel</a></td>";
	echo"</tr>";
	echo"</table>";
