...
<html>
   ...
   <body>
	<form name=consulta method=post action=may18dgas.php>
...
<?php
	...
	echo"<table width=100%  border=0 class='encab'>";
		...
		echo"<tr>";
		echo"<td>Lista de registros de DGAS que necesitan actualizar documento a cedula (".$cont.")</td>";		    
		echo"</tr>";
	...
	echo"<td>TIPO</td><td>CONSE</td><td>TIPO ID</td><td>NUMERO ID</td><td>APELLIDO 1</td><td>APELLIDO 2</td><td>NOMBRE 1</td><td>NOMBRE 2</td><td>F.NACIMIENTO</td><td>EDAD</td><td>SEXO</td><td>DEPARTAMENTO</td><td>MUNICIPIO</td><td>EPS</td><td>P. A LIQUIDAR</td><td>ZONA</td><td>F. AFILIACION</td><td>DIAS</td><td>MODALIDAD</td><td>N. DE PAGO</td><td>CAMBIO EPS</td><td>EPS TRASLADO</td><td>VALOR UPC</td><td>GLOSAS</td>";
	...
	echo"<tr>";
	echo"<td><a href=exmay18dgas.php>Exportar datos a Excel</a></td>";
	echo"</tr>";
	echo"</table>";
