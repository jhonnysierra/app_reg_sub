...
<html>
   ...
   <body>
	<form name=consulta method=post action=regsubcontri.php>
...
<?php
	...
	$cont=0;
		...
		while($j<$fil)
			...
			$consul="select numide,estado from contributivo where numide='$ced[$j]'";
...
<?php
	...
	echo"<table width=100%  border=0 class='encab'>";
		...
		echo"<tr>";
		echo"<td>Lista de registros que están en régimen subsidiado y están en régimen contributivo por documento (".$cont.")</td>";		    
		echo"</tr>";
	...
	echo"<tr>";
	echo"<td><a href=exregsubcontri.php>Exportar datos a Excel</a></td>";
	echo"</tr>";
	echo"</table>";  
