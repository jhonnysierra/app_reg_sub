...
<html>
   ...
   <body>
	<form name=consulta method=post action=regsub-sis.php>
...
<?php
	...
	echo"<table width=100%  border=0 class='encab'>";
		...
		echo"<tr>";
		echo"<td>Lista de registros de régimen subsidiado que no están en sisben por documento (".$cont.")</td>";		    
		echo"</tr>";
	...
	echo"<tr>";
	echo"<td><a href=exregsub-sis.php>Exportar datos a Excel</a></td>";
	echo"</tr>";
	echo"</table>"; 	
?>
